...
Contoh Command : [`./commands/other/botstat.js`](https://github.com/Firman-Craft/elaina-md/blob/master/commands/other/botstat.js)<br />
...
- [`Owner Here`](https://wa.me/6285784227057?text=Bang) 
...
> pkg install nodejs
> git clone https://github.com/Firman-Craft/elaina-md
> cd elaina-md
> yarn install
> npm start
# Scan QR
...
```bash
# clone repo
git clone --depth=1 https://github.com/Firman-Craft/elaina-md
...
-    [`firman`](https://github.com/Firman-Craft) 
